...
AjaxSolr.PagerWidget = AjaxSolr.AbstractWidget.extend(
  ...
  clickHandler: function (page) {
    ...
    return function () {
      ...
      //self.manager.flag_TagFacetRequest = true;
      //Set Pagination Request Flag
      self.manager.flag_PaginationRequest = true;
      self.doRequest();
      return false;
    }
  },
  ...
  /**
   * An abstract hook for child implementations clean.
   */
  ...
  afterRequest: function () {
    //Clean Pagination Request Flag
    this.manager.flag_PaginationRequest = false;
